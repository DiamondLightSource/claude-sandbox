...
| `/usr/libexec/claude-sandbox/pi-dist/` | Pinned Pi standalone release, verified against release checksums | Pi executable and assets, read-only inside the sandbox; Linux x64 and arm64. No separate Node.js runtime needed |
