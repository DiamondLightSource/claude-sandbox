...
The `--gpu` option exists in 4.7.0 but is not yet functional and is under
development.
...
In your own devcontainer, configure runtime device access and add
...
can cross the sandbox boundary; device resource exhaustion and side
